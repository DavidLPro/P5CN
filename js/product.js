...
choixCouleur.addEventListener("input", (eventcolor) => {
let couleurProduit;
// on récupère la valeur de la cible de l'évenement dans couleur
couleurProduit = eventcolor.target.value;
...
choixQuantité.addEventListener("input", (eventquantité) => {
// on récupère la valeur de la cible de l'évenement dans couleur
quantitéProduit = eventquantité.target.value;
...
console.log(JSON.stringify(produitsEnregistrés));
